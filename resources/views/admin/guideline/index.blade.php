    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <!--PAGE CONTENT BEGINS-->
                <form accept-charset="utf-8" method="post" action="{{ url('admin/guide/store') }}" class="form-horizontal"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    html += '<div class="col-md-12" id="update_form"><div class="control-group">' +
                        ...
                        '<div class="controls">' +
                        '<input type="text" placeholder="Title" name="edit_title" id="edit_title" class="from-control edit-from-control" value="' +
