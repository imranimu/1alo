...
<body>
    ...
    <table class="datatable" style="100%">
        ...
        <tbody>
            <tr>
                ...
                <td>DET</td>
                <td>Sana Shaikh</td>
                <td width="180px"><img src="{{ public_path('images/signature.jpg') }}"
    ...
    <p><b>STUDENT:</b> {{ $getUserInfo->first_name }} {{ $getUserInfo->last_name }}</p>
    <p><b>DOB:</b> {{ $getUserInfo->dob }}</p>
    <p><b>ADDRESS:</b> {{ $getUserInfo->address1 }}</p>
    <p><b>CITY/STATE/ZIP:</b> {{ $getUserInfo->city_town }}/{{ $getUserInfo->postcode }}</p>
    <p><b>PHONE:</b> {{ $getUserInfo->mobile_no }}</p>
