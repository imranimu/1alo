...
@section('content')
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="javascript:void(0)">Courses Lists</a></li>
        </ul>
        <!--.breadcrumb-->
    </div>
            ...
            <div class="span12">
                ...
                <form accept-charset="utf-8" method="post" action="{{ url('admin/course/store-course-module') }}"
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                            <textarea type="text" placeholder="Name" name="description" id="description">{{ old('description') ? old('description') : '' }}</textarea>
                    ...
                    @forelse($records as $val)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" onclick="deleteData({{ $val->courses_id }}, {{ $val->id }})"><span
    ...
    <!--/.row-fluid-->
    <script>
        function deleteData(courses_id, id) {
            bootbox.confirm({
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    html += '<div class="col-md-12" id="update_form"><div class="control-group">' +
                        ...
                        '<div class="controls">' +
                        '<input type="text" placeholder="Description" name="edit_description" id="edit_description" value="' +
                        ...
                        '<div class="controls">' +
                        '<input type="text" placeholder="Duration" name="edit_duration" id="edit_duration" value="' +
