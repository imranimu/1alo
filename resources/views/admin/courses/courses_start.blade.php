...
@section('content')
	 <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">{{ !blank($getCourses) ? $getCourses->title : '' }}</li>
        </ul>
        <!--.breadcrumb-->
    </div>
            ...
            <div class="row" style="margin-left: 0;"> 
                ...
                <div class="col-2">
                    <a href="javascript:;" data-toggle="modal" data-target="#chooseBook"
                            class="btn btn-primary">Select Book or Chapter</a>
                </div>

                <div class="col-2">
                    <select class="book_page form-control" style="height: 46px !important; width: 100%; margin: 0px; border-radius: 10px;" onchange="changeLession(this.value)">
