...
@section('content')
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ url('admin/course/' . Request::segment(3) . '/course-module-add') }}">Course
                                module</a></li>
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-xl-5">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Course Lesson Add</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.course.store-course-lesson') }}" accept-charset="utf-8" method="post"
                        ...
                        <div class="form-actions">
                            <button type="submit" name="submit" value="submit" style="width: 70%" class="btn btn-primary"
                                onclick="fileUpload()">
        ...
        <div class="col-xl-7">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Course Lesson Edit</h4>
                </div><!-- end card header -->
                        ...
                        <div class="accordion accordion-icon-none" id="accordionWithouticon">
                            ...
                            @forelse($get_course_lesson as $val)
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="accordionwithouticonExample{{ $count }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#accor_withouticoncollapse{{ $count }}"
                                            aria-expanded="true"
                                            aria-controls="accor_withouticoncollapse{{ $count }}">
                                            <i class="ri-global-line me-2"></i> {!! $val->title !!}
                                        </button>
                                    </h2>
                                    <a href="javascript:void(0)" onclick="delectLesson()" class="accordion1Delete"><i
                                            class="ri-delete-bin-line"></i></a>
                                    <div id="accor_withouticoncollapse{{ $count }}"
                                        class="accordion-collapse collapse {{ $class }}"
                                        aria-labelledby="accordionwithouticonExample{{ $count }}"
                                        data-bs-parent="#accordionWithouticon">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <form
                                                        action="{{ url('admin/course/' . $val->id . '/update-course-lesson') }}"
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input type="text"
                                                                    name="edit_title{{ $val->id }}"
                                                                    id="edit_title{{ $val->id }}"
                                                        ...
                                                        <div class="control-group">
                                                            <label class="control-label"
                                                                for="edit_lesson_type{{ $val->id }}">Lesson Type
                                                                *</label>
                                                            <div class="controls">
                                                                <select name="edit_lesson_type{{ $val->id }}"
                                                                    id="edit_lesson_type{{ $val->id }}"
                                                                    class="form-control"
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="file"
                                                                    name="edit_file_pdf_text{{ $val->id }}"
                                                ...
                                                <div class="col-md-5 left-dot-border">
                                                    ...
                                                    @if ($val->lesson_type == 'video' || $val->lesson_type == 'audio')
                                                        <div class="control-group">
                                                            <label class="control-label"
                                                                for="page"><b>{{ Str::ucfirst($val->lesson_type) }} :
                                                                </b></label>
                                                            <div class="controls">
                                                                <label><a href="javascript:void(0)"
                                                                        onclick="showFile('{{ $val->lesson_type }}', '{{ $media }}')">{{ $media }}</a></label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if ($val->text_pdf != '')
                                                        ...
                                                        @endphp
                                                        <div class="control-group">
                                                            <label class="control-label" for="page"><b>PDF :
                                                                </b></label>
                                                            <div class="controls">
                                                                <label><a href="javascript:void(0)"
                                                                        onclick="showFile('{{ $extension }}', '{{ $pdf }}')">{{ $pdf }}</a></label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="fileShow" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        ...
        function showFile(lesson_type, media) {
            ...
            if (lesson_type == 'video') {
                HTML += '<video width="100%" controls>' +
                    '<source src="' + path + '/' + moduleID + '/' + media +
                ...
                let fullPathDoc = 'https://view.officeapps.live.com/op/view.aspx?src=' + path + '/' + moduleID + '/' +
                    media;
                HTML += '<iframe src="' + fullPathDoc +
