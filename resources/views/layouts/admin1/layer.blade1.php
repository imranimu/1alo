    ...
    <div id="layout-wrapper">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ url('/') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/frontend/img/logo-2.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/frontend/img/logo-2.png') }}" alt="" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="{{ url('/') }}" class="logo logo-light">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('admin/question/exam-show') }}">
                                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-widgets">Manage Exams</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('admin/document/show') }}">
                                <i class="ri-stack-line"></i> <span data-key="t-widgets">Documents Upload</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('admin/license/add-license') }}">
                                <i class="ri-file-list-3-line"></i> <span data-key="t-widgets">License Number</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('admin/certificate') }}">
                                <i class="ri-award-fill"></i> <span data-key="t-widgets">Certificate lists</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('admin/payment/show') }}">
                                <i class="ri-secure-payment-fill"></i> <span data-key="t-widgets">Payment List</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#userPages" data-bs-toggle="collapse" role="button"
                                ...
                                <i class="ri-account-circle-line"></i> <span data-key="t-pages">User List</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#settingPages" data-bs-toggle="collapse"
                                ...
                                <i class="ri-settings-5-line"></i> <span data-key="t-pages">Setting</span>
                            </a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> © Drive Safe Driving School.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by devaic
                            </div>
                        </div>
                    </div>
                </div>
